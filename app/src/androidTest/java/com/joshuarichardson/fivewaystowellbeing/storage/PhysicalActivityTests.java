...
public class PhysicalActivityTests {
    ...
    public void setup() {
        ...
        this.physicalActivityDao.insert(new PhysicalActivity("CYCLE", null, 543789, 6543212, 595448, false, false));
    }

    @Test
    public void whenActivityIsInserted_ItShouldBeRetrievableByType() {
        this.physicalActivityDao.insert(new PhysicalActivity("RUN", null, 321543, 4374857, 3784283, false, false));
        PhysicalActivity originalPhysicalActivity = this.physicalActivityDao.getPhysicalActivityByTypeWithAssociatedActivity("RUN");
    ...
    public void whenGettingPhysicalActivityById_TheCorrectPhysicalActivityShouldBeReturned() {
        PhysicalActivity originalPhysicalActivity = this.physicalActivityDao.getPhysicalActivityByTypeWithAssociatedActivity("CYCLE");
    ...
    public void whenStartTimeUpdated_ThePhysicalActivityShouldReturnTheNewTime() {
        ...
        PhysicalActivity newPhysicalActivity = this.physicalActivityDao.getPhysicalActivityByTypeWithAssociatedActivity("CYCLE");
    ...
    public void whenGetPending_CorrectNumberOfItemsShouldBeReturned() {
        ...
        this.physicalActivityDao.insert(new PhysicalActivity("RUN", null, 321543, 4374857, 3784283, true, false));
        this.physicalActivityDao.insert(new PhysicalActivity("RUN", null, 321543, 4374857, 3784283, true, false));

        this.physicalActivityDao.insert(new PhysicalActivity("WALK", null, 321543, 4374857, 3784283, true, false));
    ...
    public void whenRequestingAllActivitiesWithoutNames_ShouldReturnNonNullNames() {
        this.physicalActivityDao.insert(new PhysicalActivity("com.even_less_fun", "C", 321543, 4374857, 453787, true, false));
        this.physicalActivityDao.insert(new PhysicalActivity("com.less_fun", "A", 321543, 4374857, 0, true, false));
        this.physicalActivityDao.insert(new PhysicalActivity("com.fun", "B", 321543, 4374857, 3784283, true, false));
        this.physicalActivityDao.insert(new PhysicalActivity("com.no_fun", null, 321543, 4374857, 45873, true, false));

        List<PhysicalActivity> activities = this.physicalActivityDao.getAllPhysicalActivitiesWithNamesAndAssociatedActivities();
