...
public class WellbeingRecordTests {
    ...
    public void setup() {
        ...
        this.surveyActivityId1 = surveyActivityDao.insert(new SurveyResponseActivityRecord(surveyId, activityId, 1, "note 1",  1612427791, 1612427795, 1));
        this.surveyActivityId2 = surveyActivityDao.insert(new SurveyResponseActivityRecord(surveyId, activityId, 2, "note 2",  1712427792, 1712427796, 1));
        this.surveyActivityId3 = surveyActivityDao.insert(new SurveyResponseActivityRecord(surveyId, activityId, 1, "note 3",  1812427793, 1812427797, 1));
