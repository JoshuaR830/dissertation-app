...
@HiltAndroidTest
@Config(application = HiltTestApplication.class, maxSdk = 25)
...
//    public ActivityScenarioRule<MainActivity> mainActivity = new ActivityScenarioRule<>(MainActivity.class);
    ...
    @Before
    public void setup() {
        this.scenario = ActivityScenario.launch(MainActivity.class);
        hiltTest.inject();
    }
...
//            onView(withId(R.id.individual_survey_time)).check(matches(isDisplayed()));
//        });
    }
}
